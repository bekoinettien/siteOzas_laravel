...
<section class="service_section layout_padding">
    <div class="container ">
      <div class="titre">
        @foreach ($service_formation as $index => $services_formation)
        <h2> Detail  <span>{{ $services_formation->titre }}</span></h2>
        @endforeach
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-8">
          <div class="box-service-odoo ">
            <div>
              <img src="/storage/service_formation/{{ basename($services_formation->path_image) }}" style="max-width:100%; height: 270px; padding-top:10px">
              <h4>{{ $services_formation->titre }}</h4>
              <p>{{ $services_formation->description}}</p>
          ...
          <div class="bout">
            ...
            <a href="/formation/edit/{{$services_formation->id}}" class=" btn btn-success mod">MODIFIER</a>
            @endif
