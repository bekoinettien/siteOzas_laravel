...
<section class="service-odoo1">
    ...
    <form method="POST" action="/edit" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="titre" class="form-control" value="{{$service_odoo->titre}}" required>
            @error('titre')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea id="description" type="text" name="description" class="form-control" rows="4" required >{{ $service_odoo->description }}</textarea>
            @error('description')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
