...
<section class="service_section layout_padding">
    <div class="container ">
      <div class="titre">
        @foreach ($service_devweb as $index => $services_devweb)
        <h2> Detail  <span>{{ $services_devweb->titre }}</span></h2>
        @endforeach
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-8">
          <div class="box-service-odoo ">
            <div>
              <img src="/storage/service_devweb/{{ basename($services_devweb->path_image) }}" style="max-width: 100%; height: 270px; padding-top:10px">
              <h4>{{ $services_devweb->titre }}</h4>
              <p>{{ $services_devweb->description}}</p>
          ...
          <div class="bout">
            ...
            <a href="/devweb/edit/{{$services_devweb->id}}" class=" btn btn-success mod">MODIFIER</a>
            @endif
